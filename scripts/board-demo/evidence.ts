...
export function buildSyntheticEvidence() {
  const records = [
    ...
    ["meter-reading", "Synthetic meter reading", "A fictional observation used to trace a demo activity entry. Quantity must be filled from the generated activity manifest."],
