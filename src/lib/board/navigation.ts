...
export const BOARD_NAV: BoardNavItem[] = [
  ...
  { id: "data", label: "Data Collection", href: "/data", matches: ["/data"], group: "workspace" },
  { id: "activity", label: "Activity Register", href: "/activity", matches: ["/activity"], group: "workspace" },
  { id: "entry", label: "Data Entry", href: "/entry", matches: ["/entry"], group: "workspace" },
